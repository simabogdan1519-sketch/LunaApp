...
class _MainScaffoldState extends State<MainScaffold> {
  ...
  Widget build(BuildContext context) {
    ...
    final navItems = [
      ...
      const BottomNavigationBarItem(icon: Text('🩺', style: TextStyle(fontSize: 20)), label: 'Medical'),
      const BottomNavigationBarItem(icon: Text('🔔', style: TextStyle(fontSize: 20)), label: 'Reminders'),
